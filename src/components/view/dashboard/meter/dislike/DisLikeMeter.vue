  ...
  <div class="is-clearfix my-3">
    <div class="columns is-clearfix has-background-white is-mobile my-1 py-2">
      <div class="column is-3 has-text-centered">
        <ThumbDownIcon title="" class="is-size-4 has-text-primary" />
        <h6 class="subtitle is-7">Like</h6>
      </div>
      <div class="column is-7">
        <h6 class="is-size-7 has-text-weight-bold mb-1"> {{ getTotalNewsDislikesCount }} </h6>
        <p>{{getTotalNewsDislikesCountBasedOnDateRange}} dislikes came in last 30 days</p>
      </div>
...
export default {
  ...
  computed: {
    ...mapGetters([
      "getTotalNewsDislikesCount",
      "getDislikePercentage",
      "getTotalNewsDislikesCountBasedOnDateRange"
    ])
  },
  created() {
    let date = new Date();
